...
int resrob(realtype, N_Vector yy, N_Vector yp, N_Vector rr, void *)
{
...
static int grob(realtype, N_Vector yy, N_Vector, realtype *gout,
                void *)
{
  realtype *yval, y1, y3;
...
int jacrob(realtype, realtype cj,
           N_Vector yy, N_Vector, N_Vector,
           SUNMatrix JJ, void *,
...
static void PrintHeader(realtype, N_Vector, N_Vector)
{
#if 0
  realtype *atval, *yval;
...
static void PrintRootInfo(int, int)
{
#if 0
...
static int check_ans(N_Vector y, realtype, realtype rtol, N_Vector atol)
{
