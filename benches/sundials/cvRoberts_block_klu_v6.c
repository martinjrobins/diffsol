...
int cvRoberts_block_klu(int ngroups)
{
  SUNContext sunctx;
 ...
 *-------------------------------
 */
static int f(realtype, N_Vector y, N_Vector ydot, void *user_data)
{
  UserData *udata;
  sunindextype groupj;
...
static int Jac(realtype, N_Vector y, N_Vector, SUNMatrix J,
