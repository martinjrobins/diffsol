...
#define MX SIZE /* MX = number of x mesh points      */
#define MY SIZE /* MY = number of y mesh points      */
...
static void PrintHeader(sunindextype, sunindextype, realtype, realtype)
{
#if 0
...
static void PrintOutput(void *, N_Vector, realtype)
{
#if 0
  int i, kused, retval;
  long int nst;
...
static void Fweb(realtype, N_Vector cc, N_Vector crate,
                 UserData webdata)
{
