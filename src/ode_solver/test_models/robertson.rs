...
pub fn robertson<M: DenseMatrix + 'static>() -> (
    ...
    #[rustfmt::skip]
    let data = vec![
        (vec![1.0.into(), 0.0.into(), 0.0.into()], 0.0.into()),
        (vec![9.8517e-01.into(), 3.3864e-05.into(), 1.4794e-02.into()], 0.4.into()),
        (vec![9.0553e-01.into(), 2.2406e-05.into(), 9.4452e-02.into()], 4.0.into()),
        (vec![7.1579e-01.into(), 9.1838e-06.into(), 2.8420e-01.into()], 40.0.into()),
        (vec![4.5044e-01.into(), 3.2218e-06.into(), 5.4956e-01.into()], 400.0.into()),
        (vec![1.8320e-01.into(), 8.9444e-07.into(), 8.1680e-01.into()], 4000.0.into()),
        (vec![3.8992e-02.into(), 1.6221e-07.into(), 9.6101e-01.into()], 40000.0.into()),
        (vec![4.9369e-03.into(), 1.9842e-08.into(), 9.9506e-01.into()], 400000.0.into()),
        (vec![5.1674e-04.into(), 2.0684e-09.into(), 9.9948e-01.into()], 4000000.0.into()),
        (vec![5.2009e-05.into(), 2.0805e-10.into(), 9.9995e-01.into()], 4.0000e+07.into()),
        (vec![5.2012e-06.into(), 2.0805e-11.into(), 9.9999e-01.into()], 4.0000e+08.into()),
        (vec![5.1850e-07.into(), 2.0740e-12.into(), 1.0000e+00.into()], 4.0000e+09.into()),
        (vec![4.8641e-08.into(), 1.9456e-13.into(), 1.0000e+00.into()], 4.0000e+10.into()),
    ];

    for (values, time) in data {
        soln.push(M::V::from_vec(values), time);
    }
