...
- `cuda-oxide`: Use in-built [cuda-oxide](https://github.com/NVlabs/cuda-oxide) linear algebra containers and solvers (disabled by default). This needs the cuda-oxide toolchain, see the `Justfile` for more information.
