...
- [Specifying ODE problems](./specify/specifying_the_problem.md)
  ...
  - [OdeEquations trait](./specify/trait/ode_equations_trait.md)
    ...
    - [Parameters](./specify/trait/parameters.md)
  - [Batching](./specify/batching/batching.md)
    - [Builder](./specify/batching/builder.md)
    - [Vector Traits](./specify/batching/vector_traits.md)
