...
```rust,ignore
{{#include ../../../examples/mass-spring-fitting-adjoint.rs::24}}
```
...
```rust,ignore
{{#include ../../../examples/mass-spring-fitting-adjoint.rs:26:45}}
```
...
```rust,ignore
{{#include ../../../examples/mass-spring-fitting-adjoint.rs:47:70}}
```
...
```rust,ignore
{{#include ../../../examples/mass-spring-fitting-adjoint.rs:72::}}
```
