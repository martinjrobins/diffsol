...
fn compile_benches(sundials: &Library, suitesparse: &Library) -> Vec<String> {
...
fn generate_bindings(suitesparse: &Library, sundials: &Library) -> Result<PathBuf, String> {
